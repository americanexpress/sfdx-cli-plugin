...
const aws = {
    ...
    get s3() {
        try {
            return cache.s3 = cache.s3 || new (require('aws-sdk/clients/s3'))(this.creds);
        }
        catch (err) {
    ...
    get cloudfront() { return cache.cloudfront = cache.cloudfront || new (require('aws-sdk/clients/cloudfront'))(this.creds); },
};
exports.default = {
    get cloudfront() {
        return {
