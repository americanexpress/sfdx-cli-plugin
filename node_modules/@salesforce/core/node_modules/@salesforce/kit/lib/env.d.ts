import { Dictionary, KeyValue, Optional } from '@salesforce/ts-types';
/**
...
export declare class Env {
     ...
     * ```
     */
    getKeyOf<T extends object>(key: string, obj: T, transform?: (k: string) => string): Optional<Extract<keyof T, string>>;
    /**
     * Gets a `string` value from a finite set of expected values derived from the keys of a given object of type `T`,
     ...
     * ```
     */
    getKeyOf<T extends object>(key: string, obj: T, def: string, transform?: (k: string) => string): Extract<keyof T, string>;
    /**
