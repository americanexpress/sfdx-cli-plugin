...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <alerts>
        <fullName>MSE_Marketer_for_updates</fullName>
        <description>Trigger An email when Case with MSE record type needs update to case from the Marketer</description>
        <protected>false</protected>
        <recipients>
            <type>owner</type>
        </recipients>
        <senderAddress>testuser@myorg.com</senderAddress>
        <senderType>OrgWideEmailAddress</senderType>
        <template>SampleProject_Support/SUPPORT_Case_updates_needed_for_MSE</template>
    </alerts>
    <alerts>
